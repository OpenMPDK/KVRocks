...
extern atomic64_t kv_total_sync_wait_time;
...
#define KV_MAX_INFLIGHT_REQUEST_PER_QUEUE 64
#endif
...
struct kv_iosched_struct{
    ...
    unsigned long max_inflight_request;	/* workqueue & congestion status. */
    atomic_t nr_congested;
    atomic_t in_flight_rq[MAX_HOST_CPU];
 ...
 */
extern int __nvme_submit_iosched_kv_cmd(struct kv_memqueue_struct *memq, int qid);
