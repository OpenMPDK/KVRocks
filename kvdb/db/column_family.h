...
class ColumnFamilyHandleImpl : public ColumnFamilyHandle {
 public:
  ...
  virtual std::vector<std::unique_ptr<TablePropertiesCollector>> *GetTablePropCollectors() {
      return &table_properties_collectors_;
  }
 ...
 private:
  ...
  std::vector<std::unique_ptr<TablePropertiesCollector>> table_properties_collectors_;
};
