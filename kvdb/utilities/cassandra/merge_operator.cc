...
std::once_flag flag1;
std::shared_ptr<MergeOperator> instance;

std::shared_ptr<MergeOperator> CassandraValueMergeOperator::CreateSharedInstance() {
    std::call_once(flag1, [](){
        instance.reset(new CassandraValueMergeOperator());
    });
