...
//}
//
////tailing kvdb不支持，7月份以后在测试,将iter<2改成iter<1
...
///*
////////////////////////////Tailing Iterator//////////////////////////
//TEST_F(DBIteratorTest, TailingIteratorSingle) {
//  Open();
//  ReadOptions read_options;
...
/////core dump
///*
//TEST_F(DBIteratorTest, TailingIteratorKeepAdding) {
//  Open();
//  CreateAndReopenWithCF({"pikachu"}, CurrentOptions());
//  ReadOptions read_options;
//  read_options.tailing = true;
...
//    char buf[32];
//    snprintf(buf, sizeof(buf), "%016d", i);  //"%016d"的格式格式化为i，然后再将其拷贝至buf中。
//  cout <<"----------2----------------"<<endl;
//    Slice key(buf, 16);
//  cout <<"----------3----------------"<<endl;
//  //ASSERT_OK(Put(1, key.ToString(), value));
//  ASSERT_OK(db_->Put(WriteOptions(), handles_[1], key.ToString(), value));  //core dump
//  cout <<"----------4----------------"<<endl;
//    iter->Seek(key);
//    ASSERT_TRUE(iter->Valid());
...
//*/
///*
//TEST_F(DBIteratorTest, TailingIteratorSeekToNext) {
//  Open();
//  CreateAndReopenWithCF({"pikachu"}, CurrentOptions());
//  ReadOptions read_options;
//  read_options.tailing = true;
...
//*/
///*
//TEST_F(DBIteratorTest, TailingIteratorTrimSeekToNext) {
...
//
///*
//TEST_F(DBIteratorTest, TailingIteratorDeletes) {
//  Open();
//  CreateAndReopenWithCF({"pikachu"}, CurrentOptions());
//  ReadOptions read_options;
//  read_options.tailing = true;
...
//*/
///*
//TEST_F(DBIteratorTest, TailingIteratorPrefixSeek) {
//  Open();
//  ReadOptions read_options;
//  read_options.tailing = true;
//  Options options = CurrentOptions();
...
////
////
//////From Db_iter_test.cc  
////
//
///*
////NewDBIterator not supported by kvdb?
