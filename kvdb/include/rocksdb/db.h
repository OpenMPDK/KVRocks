...
struct ColumnFamilyDescriptor {
  ...
  ColumnFamilyDescriptor()
      : name(kDefaultColumnFamilyName), options(ColumnFamilyOptions()), ttl(0), ttl_enabled(false) {}
  ColumnFamilyDescriptor(const std::string& _name,
                         const ColumnFamilyOptions& _options)
      : name(_name), options(_options), ttl(0), ttl_enabled(false) {}
};
...
class DB {
 public:
  ...
  //set ttl for column_family
  virtual Status SetColumnFamilyTtl(ColumnFamilyHandle* column_family, uint32_t ttl);
